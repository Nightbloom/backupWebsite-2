...
export default function Navbar() {
    ...
    <div>
        ...
        <ul className="links-container">
            <li className="links-item link active" style={{fontSize:"21px", color:"black"}}>MENU</li>
            <li className="links-item"><Link to="/" className="link active" style={{color:"green"}}>Home</Link></li>
            <li className="links-item"><Link to="/" className="link active" style={{color:"green"}}>Track Your Order</Link></li>
            <li className="links-item"><Link to="/" className="link " style={{color:"green"}}>About Us</Link></li>
        </ul>
    </nav>
